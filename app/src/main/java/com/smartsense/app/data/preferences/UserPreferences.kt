...
class UserPreferences @Inject constructor(
     ...
     * surfaces that would otherwise clutter the end-user UI — currently the Raw Data
     * card on the sensor detail screen and the "Load mock data" overflow menu on the
     * scan screen.
     */
