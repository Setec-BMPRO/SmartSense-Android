...
class BleManager @Inject constructor(
    ...
    fun startScan(): Flow<ScannedSensor> = callbackFlow {
        ...
        try {
            ...
            Log.d(TAG, "BLE scan started with service UUID filters (ADA0, FEE5)")
    ...
    private fun parseScanResult(result: ScanResult): ScannedSensor? {
        ...
        Log.d(TAG, "MOPEKA_LPG ${result.device.address}: " +
                "hw=$hwType, type=${parsed.sensorType.displayName}, " +
                "rssi=${result.rssi}, syncPressed=${parsed.syncPressed}")
